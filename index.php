        ...
        <div class="container">
          <h1 class="title has-text-centered has-text-weight-bold">🚨 Al lío</h1>
           <div class="container" style="max-width: 500px">
            ...
            <a data-splitbee-event="Submit Random Salary" class="button is-link is-light is-fullwidth" href="results.php?salary=<?php echo rand(100000, 2000000); ?>">¡Randomizar!</a>
          </div>
        </div>
      </div>
    </section>
